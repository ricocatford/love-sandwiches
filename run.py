...
def update_sales_worksheet(data):
    ...
    print("Sales worksheet updated successfully! Thank you.\n")
...
def update_surplus_worksheet(data):
    ...
    print("Surplus worksheet updated successfully! Thank you.\n")
...
def main():
    ...
    surplus_data = update_surplus_worksheet(new_surplus_data)
    print(surplus_data)
